...
export const App = () => {
  ...
  return (
    <div
      className={`app flex flex-col py-4 px-6 sm:px-24 md:px-24 ${
        darkMode ? "dark" : ""
      }`}
    >
      <div className="intro mb-10">
        ...
        <p className="bio leading-5 tracking-wide md:text-lg">
          <strong>Full-stack developer</strong> experienced in JavaScript,
          React, Redux, Ruby on Rails, Linux, and chess. Open to new
          opportunities.
        </p>
      </div>
      ...
      <div className="skills mb-20">
        ...
        <p className="mb-2 md:text-lg">
          {" "}
          Here are some of the skills I have acquired over the years in no
          particular order:
        </p>
